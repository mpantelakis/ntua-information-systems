select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    from postgresql.public.store_sales,postgresql.public.date_dim,postgresql.public.store,mongodb.tpcds.household_demographics,mongodb.tpcds.customer_address 
