...
cross_sales as
 (select i_product_name product_name
  ...
  FROM   postgresql.public.store_sales
        ...
        ,postgresql.public.household_demographics hd1
        ,postgresql.public.household_demographics hd2
        ,postgresql.public.customer_address ad1
        ,postgresql.public.customer_address ad2
        ,postgresql.public.income_band ib1
        ,postgresql.public.income_band ib2
