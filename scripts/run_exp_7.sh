...
# This script runs experiment 7 for Analysis & Design of Information Systems 2024-2025.

QUERIES_DIR=~/tpc-ds/tpcds-queries/distribution-method-4
COORDINATOR_IP=<your-coordinator-ip>

echo "=========================================================================="
echo "Commencing Experiment 7 using Data Distribution Strategy 4 and 3 Workers"
echo "=========================================================================="
echo
echo
