...
# This script runs experiment 6 for Analysis & Design of Information Systems 2024-2025.

QUERIES_DIR=~/tpc-ds/tpcds-queries/distribution-method-4
COORDINATOR_IP=<your-coordinator-ip>

echo "=========================================================================="
echo "Commencing Experiment 6 using Data Distribution Strategy 4 and 2 Workers"
echo "=========================================================================="
echo
echo
