...
# This script runs experiment 4 for Analysis & Design of Information Systems 2024-2025.

QUERIES_DIR=~/tpc-ds/tpcds-queries/distribution-method-3
COORDINATOR_IP=<your-coordinator-ip>

echo "==========================================================="
echo "Commencing Experiment 4 using Data Distribution Strategy 3"
echo "==========================================================="
echo
echo
