...
# This script runs experiment 1 for Analysis & Design of Information Systems 2024-2025.
...
if [ -z "$1" ]; then
    ...
    if [ "$1" == "postgresql" ]; then
        export CATALOG_NAME="PostgreSQL"
        export PRESTO_CATALOG="postgresql"
        export PRESTO_SCHEMA="public"
    elif [ "$1" == "cassandra" ]; then
        export CATALOG_NAME="Cassandra"
        export PRESTO_CATALOG="cassandra"
        export PRESTO_SCHEMA="tpcds"
    elif [ "$1" == "mongodb" ]; then
        export CATALOG_NAME="MongoDB"
        export PRESTO_CATALOG="mongodb"
        export PRESTO_SCHEMA="tpcds"
    fi
fi

echo "============================================"
echo "Commencing Experiment 1 using $CATALOG_NAME"
echo "============================================"
echo
echo
...
OUTPUT_CSV="exp_1_${1}_results.csv"
